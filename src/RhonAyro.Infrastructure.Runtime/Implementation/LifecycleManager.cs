...
namespace RhonAyro.Infrastructure.Runtime.Implementation
{
    /// <inheritdoc />
    internal sealed class LifecycleManager : ILifecycleManager
    {
        ...
        public void Shutdown()
        {
            ...
            {
                Trace.TraceError($"Shutdown; Disposing cts threw an exception; Reason: '{ex.Message}'; Type: '{ex.GetType().Name}'");
            }
